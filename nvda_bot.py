...
while True:
    ...
    if close > ema20 and ema20 > ema50 and ema50 > ema100 and rsi > 50 and rsi < 70:
        print("BUY SIGNAL")
        send_telegram_message("🚀 BUY SIGNAL for NVDA")

    elif close < ema20 or rsi > 75 or rsi < 45:
        print("SELL SIGNAL")
        send_telegram_message("🔴 SELL SIGNAL for NVDA")

    else:
        print("NO CLEAR SIGNAL")
        send_telegram_message("No clear signal for NVDA")
